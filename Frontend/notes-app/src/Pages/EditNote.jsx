...
function EditNote() {
  ...
  const handleSubmit = (e) => {
    ...
    updateNote(numericId, formData);
    navigate(`/notes/${numericId}`);
  };
      ...
      <div className="min-h-screen bg-gray-50">
        <div className="max-w-3xl mx-auto p-6">
          ...
          <div className="mt-6 bg-white border border-gray-200 rounded-2xl p-8 text-center">
            ...
            <p className="text-gray-600">The note you are trying to edit does not exist.</p>
          </div>
        </div>
      </div>
    );
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <div className="max-w-3xl mx-auto p-6">
        <div className="flex items-center justify-between">
          <button
            onClick={() => navigate(`/notes/${numericId}`)}
            className="px-3 py-2 rounded-lg bg-gray-100 text-gray-700 hover:bg-gray-200 text-sm font-medium"
          >
            <ArrowLeft size={16} className="inline mr-2" /> Back to note
          </button>
        </div>
